#install webdriver from site for the browser version
#pip install virtualenv
#pip install virtualenvwrapper-win
#pip install pipenv   if needed   the pipenv shell for virtual env
...
chrome_driver_path = 'I:/python/Indiarace/test_selenium/chromedriver'
